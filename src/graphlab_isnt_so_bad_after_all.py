...
sim_model = graphlab.factorization_recommender.create(train, user_id='user_id', item_id='movie_id', target='rating', item_data=movies,
														num_factors=20, regularization=0.1, max_iterations=1000)
